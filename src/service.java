...
public class service {
	...
	public static void webServe(int port) throws IOException {
		...
		while(true) {
			...
			String response = "HTTP/1.1 200 OK\r\n\r\n" + substituteCSS(readCSS(),verifyHex(parseHeader("main", output),"366399"),verifyHex(parseHeader("accent", output),"665399"), verifyFont(parseHeader("font",output),"monospace"));
			// Write the HTTP message out to the output stream, back to the client/user1
